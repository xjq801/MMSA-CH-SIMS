...
- [completed] F. 运行与交付（15–18）：任务15/16/18及hash-bound `HANDOFF_20.md`均已完成；00独立最终裁定`G3=PASS_WITH_LIMITATIONS`，限制继续传播。
- [completed] G. G3补证：00审查记录已由其自行提交为`3273ab2`；机器manifest、`HANDOFF_20.md`和离线validator经全量门禁后以`e49ef9e`推送，00独立最终裁定`G3=PASS_WITH_LIMITATIONS`。
