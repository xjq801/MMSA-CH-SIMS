...
|---|---|---|---|---|---|
| 00 总控 | ACTIVE_TOTAL_CONTROL_04_READONLY_PENDING_FINAL_ANCHOR | `019fd19d-b8ef-71f2-82b3-433168211358`（总控04；移交方总控03=`019fbdab-9037-7320-9fda-9000c58a5c4b`） | 总纲v1.23、G门、决策/风险/claim台账、S41 | 总控04已创建并等待总控03 FINAL_ANCHOR；接管后独立监督Task40且不代跑实验核心，继续Task20受限存储截止监督 | `.light/handoff/S41-total-control-04-migration.md` |
...
| 40 可信净收益反应记忆与三源可靠性 | CREATED_DEVELOPMENT_ONLY_READONLY_PENDING_FINAL_ANCHOR | `019fd19c-abf3-7bf0-8530-759e38c3a6ab`（独立worktree） | `SC-20260805-01/02`、v1.23、`AUTH-00-TASK40-CNBR-DEVELOPMENT-20260805`、Task30负结果边界 | 已创建；收到最终锚点后串行执行泄漏门→错位→Oracle→point/credible router→三源/区域；Oracle无headroom立即关闭；formal test禁止，不得恢复teacher或直接合入main | 未来`HANDOFF_40.md`；`.light/handoff/S41-total-control-04-migration.md` |
