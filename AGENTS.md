...
1. 研究与阶段需求以`TAFFC_CH4_10_MONTH_MASTER_PLAN_20260713.md`当前版本为唯一总纲；任务10以总纲第17节任务10为准。
   - 本项目从总纲v1.15起只执行T-AFFC的CARM群体情绪预测路线；当前执行版本为v1.23（Task30负结果不变，主路线为无teacher的OOF历史后验净收益路由、有限反应thinning、三源不确定性与经验分布预测区域；保留Video2Reaction双轨强基线，不恢复已撤回v1.17数值门）。
