...
class MetricsTop():
    ...
    def __eval_sims_regression(self, y_pred, y_true):
        ...
        mult_a3 = self.__multiclass_acc(test_preds_a3, test_truth_a3)
        mult_a5 = self.__multiclass_acc(test_preds_a5, test_truth_a5)
        precision = precision_score(test_truth_a2, test_preds_a2, average='weighted', zero_division=0)
        recall = recall_score(test_truth_a2, test_preds_a2, average='weighted', zero_division=0)
