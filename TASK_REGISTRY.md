...
|---|---|---|---|---|---|
| 00 总控 | ACTIVE_TOTAL_CONTROL_04 | `019fd19d-b8ef-71f2-82b3-433168211358`（总控04；移交方总控03=`019fbdab-9037-7320-9fda-9000c58a5c4b`） | 总纲v1.25、G门、决策/风险/claim台账、S41—S45 | 已独立关闭Task40/45；已按用户直接执行指令冻结Task46 v1.25 P0包，等待独立执行worktree创建；仍不代跑核心实验 | S45 |
...
| 46 后验效用分布与风险约束选择（候选） | P0_PACKAGE_FROZEN_USER_AUTHORIZED_PENDING_INDEPENDENT_WORKTREE | 未创建（仅冻结P0包） | `SC-20260806-02`、总纲v1.25、`TASK00_TASK46_V125_RESEARCH_PLAN_20260807.md`、预注册/target/failure/fair/access JSON及用户执行授权 | 只允许新角色重建、跨组有效负控、FIT nested OOF效用学习和策略冻结；确认集一次性门仍未打开；同90% coverage主JSD通过前负迁移/P5不执行，Task50不创建 | `TASK00_TASK46_CREATION_AUTHORIZATION_20260807.md`；未创建 |
