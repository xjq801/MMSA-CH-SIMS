...
- 协议可复现不等于权利方已确认资产准入；维护者证明=`DEFERRED_ACCEPTED_RISK`。按`SC-20260717-01`，`G2_PROTOCOL_DATA=PASS_WITH_LIMITATIONS`、`formal_split=true`并授权任务20内部研究。I3D不得再分发；权利方否认或hash/覆盖漂移时相关运行失效。
