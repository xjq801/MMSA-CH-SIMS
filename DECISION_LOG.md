...
| `REVIEW-00-CSMV-I3D-SEQUENCE-PROTOCOL-20260716` | 2026-07-16 | 接受I3D完整序列主协议、确定性均匀180步主敏感性、论文边界与M1—M2 Git检查点 | 任务10回交、协议manifest、8项单测、专项门、19项隔离重放、release/泄漏/安全现场复核 | 关闭序列处理未冻结子缺口；不授予资产许可/revision/fixity信用；维护者证据延期；G2、`formal_split=false`与任务20禁令不变 | ACCEPTED_PREREGISTRATION_ONLY_G2_UNCHANGED |
| `SC-20260716-02` | 2026-07-16 | 批准IJCV专刊与T-AFFC条件双论文路线，并将总纲升为v1.14 | IJCV官方专刊/期刊/投稿指南；视觉情绪分布近邻；`IJCV_TAFFC_DUAL_TRACK_FEASIBILITY_AND_PLAN_20260716.md` | IJCV独立研究响应分布几何视觉表征，J0/J1/J2硬门；T-AFFC保留CARM；同稿不得双投；CSMV G2不变；任务25/65仅条件创建 | CONDITIONAL_GO_TWO_DISTINCT_PAPERS |
