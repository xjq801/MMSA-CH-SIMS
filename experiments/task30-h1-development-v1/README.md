...
- `TASK30_DATA_FLOW.md` at the repository root is the hash-bound Mermaid data-flow and edge contract proving that dev/test responses have no implemented path to the teacher or student and that formal-test rows are not materialized.
